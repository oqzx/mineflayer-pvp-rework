...
import { createProjectileAimBackend, type ProjectileAimBackend, type ProjectileAimResult } from "./aim-backend.js";
...
type RangedWeapon = (typeof RANGED_PRIORITY)[number] | "trident" | "snowball" | "ender_pearl" | "egg" | "splash_potion";
...
export class BowPVP {
    ...
    private async ensureLookedAt(yaw: number, pitch: number, epsilon: number = AIM_EPSILON): Promise<boolean> {
